...
def parse_args():
    ...
    ap.add_argument("--student", required=True,
                    help="student model key in mcip_train.MODELS (e.g. rn50)")
    ...
    ap.add_argument("--s4_dir", required=True,
                    help="dir with S4 cache (T2I reference): "
                         "img_feats_mobileclip2_s4.npy, text_feats_..., valid_...")
    ap.add_argument("--s2_dir", required=True,
                    help="dir with S2 cache (I2I reference): "
                         "img_feats_mobileclip2_s2.npy, valid_...")
    ap.add_argument("--pairs_dir", required=True,
                    help="CC12M dir (captions.tsv + images)")
    ...
    ap.add_argument("--w_t2i", type=float, default=1.0,
                    help="weight on S4 cross-modal (T2I) terms")
    ap.add_argument("--w_i2i", type=float, default=1.0,
                    help="weight on S2 image-image (I2I) term")
    ...
    for epoch in range(args.epochs):
        for batch in loader:
            ...
            loss, parts = dual_teacher_loss(
                ...
                s4_i, s4_t,            # S4 -> T2I cross-modal
                s2_i,                  # S2 -> I2I image-image
        ...
        # save ONLY the final epoch
        if epoch + 1 == args.epochs:
            ep_ckpt = os.path.join(args.out_dir,
                                   f"distill_dual_{args.student}_final.pth")
